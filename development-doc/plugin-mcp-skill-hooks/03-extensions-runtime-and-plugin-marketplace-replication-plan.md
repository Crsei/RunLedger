...
| P5 分发:安装/scope/激活 | **done**(主机 supervisor 装配除外) | 安装内核、activation 门禁、catalog/settings、cache/fetcher/manager、doctor、分发面 Session resource domain 接线与受治 git materialize 均已交付(51 用例);`plugin.config.*`、`extension.host.inspect` 与 supervisor/准入/事件桥装配待做 |
