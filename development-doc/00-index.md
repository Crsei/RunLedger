...
| TUI / 可配置主体色槽 | [`tui/27-configurable-ui-theme-and-thinking-color-plan.md`](tui/27-configurable-ui-theme-and-thinking-color-plan.md) | 用户级 `uiTheme`、三套 dark/light 预设、色槽覆盖与思考灰色、统一渲染接线 | `planned`：仅完成计划，配置与渲染尚未实现 |
