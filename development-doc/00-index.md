...
|---|---|---|---|
| Agent Harness 既有执行闭环加固 | [`Plan 14`](plan/14-agent-harness-reliability-hardening-plan.md) | 失败响应执行边界、工具输出、上下文选择、重复失败与中断恢复回归；不新增产品功能 | planned；H0–H6、代码/生产接线矩阵与分层验收见本文，尚未实施 |
