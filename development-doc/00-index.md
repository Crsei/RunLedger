...
| 运行轨迹 / Trajectory | [`trajectory/README.md`](trajectory/README.md)、[实施计划](trajectory/01-runtime-trajectory-implementation-plan.md) | 默认本地记录、配置关闭、Run/Step/Call 查询与 `/trajectory` 面板 | `planned`；当前默认值与界面尚未改变 |
