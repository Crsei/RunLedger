...
export function listNewModulePaths(): string[] {
	const candidates = new Set([
		...gitPathLines(["diff", "--name-only", "--diff-filter=A", "HEAD", "--", ...NEW_MODULE_ROOTS]),
		...gitPathLines(["ls-files", "--others", "--exclude-standard", "--", ...NEW_MODULE_ROOTS]),
	]);
	return [...candidates]
