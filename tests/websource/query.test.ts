/**
 * 移植自 oh-my-pi `test/web/search/query.test.ts`（快照 `1c0303b1`）。
 * 仅改测试框架（bun:test → vitest）与导入路径;断言与用例保持原样,以确保
 * 查询解析/约束过滤的行为与上游一致。
 */
...
import {
	...
	parseDateValue,
	parseSearchQuery,
} from "../../src/websource/search/query.ts";
import type { SearchSource } from "../../src/websource/search/types.ts";
