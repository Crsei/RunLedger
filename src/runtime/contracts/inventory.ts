...
export const CONTRACT_INVENTORY = [
	...
	{
		id: "adapter-ports",
		owner: "development-doc/runtime/04-governed-agent-harness-runtime-plan.md#contract-ports",
		modules: [
			"src/runtime/protocol/adapter.ts",
			"src/runtime/contracts/ports.ts",
			"src/runtime/contracts/port-schemas.ts",
		],
		types: [
			"AdapterPortRequest",
			"AdapterPortResult",
			"AdapterProgressAnnotation",
			"AdapterIdentityRef",
		],
		schemas: [
			"AdapterPortRequestSchema",
			"AdapterPortResultSchema",
			"AdapterProgressAnnotationSchema",
		...
		fixtures: ["tests/runtime-contracts/adapter-port-contracts.test.ts"],
		persistence: ["external_authority_ref", "ephemeral", "forbidden"],
		gaps: [],
	},
	{
		id: "user-home-layout",
	...
	{
		id: "session-owner",
		owner: "development-doc/runtime/06-session-owner-runtime-replacement-plan.md#4",
		modules: ["src/runtime/session-owner/types.ts", "src/runtime/session-owner/schemas.ts"],
		types: [
			"SessionOwnerRecord",
			"OwnerFence",
			"OwnerEndpoint",
		...
		events: ["owner.*", "driver.*", "recovery.*"],
		ports: [],
		fixtures: ["tests/runtime/session-owner/contracts.test.ts"],
		persistence: ["canonical_durable", "reconstructible_passive", "forbidden"],
		gaps: [],
	},
	{
		id: "session-server",
		owner: "development-doc/runtime/06-session-owner-runtime-replacement-plan.md#6",
		modules: ["src/runtime/session-server/protocol.ts"],
		types: [
		...
		events: [],
		ports: [],
		fixtures: ["tests/runtime/session-server/protocol.test.ts"],
		persistence: ["canonical_durable", "ephemeral", "forbidden"],
		gaps: [],
	},
	{
		id: "host-process",
		owner: "development-doc/runtime/05-multi-client-background-terminal-refactor-plan.md#R1",
		modules: [
			"src/runtime/host/types.ts",
			"src/runtime/host/contracts.ts",
			"src/runtime/host/composition.ts",
			"src/runtime/process/types.ts",
			"src/runtime/process/schemas.ts",
			"src/runtime/process/events.ts",
			"src/runtime/process/state-machine.ts",
			"src/runtime/process/output.ts",
			"src/runtime/process/manager.ts",
			"src/runtime/process/wait-coordinator.ts",
			"src/runtime/process/completion-delivery.ts",
			"src/runtime/contracts/storage-layout.ts",
		],
		types: [
			"RuntimeHostScope",
			"HostCompatibilityEnvelope",
			"ExecutionHandleRef",
			"ManagedProcessRequest",
			"ManagedProcessSummary",
			"ManagedProcessWaitResult",
			"ProcessEvent",
			"ProcessProjection",
			"ProcessManager",
		...
		events: ["process.execution.*", "process.output_checkpointed"],
		ports: ["ProcessJournal", "BackendSpawnPort"],
		fixtures: [
			"tests/runtime/host/contracts.test.ts",
			"tests/runtime/host/composition.test.ts",
			"tests/runtime/process/contracts.test.ts",
			"tests/runtime/process/manager.test.ts",
			"tests/runtime/process/wait-coordinator.test.ts",
			"tests/runtime/process/completion-delivery.test.ts",
		],
		persistence: ["canonical_durable", "reconstructible_passive", "ephemeral", "forbidden"],
		gaps: [],
	},
	{
		id: "public-surface",
		owner: "development-doc/runtime/04-governed-agent-harness-runtime-plan.md#contract-work-packages",
		modules: ["src/runtime/contracts/public.ts"],
		types: [],
		schemas: [],
		events: ["RUNTIME_EVENT_TYPES", "RUNTIME_EVENT_PAYLOAD_SCHEMAS"],
		ports: ["RUNTIME_ADAPTER_PORT_NAMES", "RUNTIME_ADAPTER_PORT_ACTIONS"],
		fixtures: [
