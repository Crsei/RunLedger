/** Governed production compaction summarizer shared by Session Owner and legacy Host adapters. */

import { runtimeDigest } from "../../protocol/foundation.ts";
import { createRuntimeId } from "../../protocol/ids.ts";
import type { Models } from "../../../models.ts";
import type { ModelCompatibilityRouter } from "../../model-routing/router.ts";
