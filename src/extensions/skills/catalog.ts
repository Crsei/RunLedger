...
function parseInvocation(value: string, explicitTrigger?: SkillTrigger): { name: string; argument?: string; trigger: SkillTrigger } | undefined {
...
export class SkillCatalog {
	...
	public constructor(skills: readonly SkillDescriptor[]) {
		this.#skills = [...skills].sort((left, right) => left.descriptor.identity.qualifiedId.localeCompare(right.descriptor.identity.qualifiedId));
