/**
 * Codex compatibility providers（默认 on，只读，不读取 Codex enable 配置）。
...
/** codex-user：`<os-user-home>/.codex/skills/`（rank 2000，默认 on）。 */
...
/** codex-project：repo boundary 内 `.codex/skills/`（rank 2100，默认 on，只读）。 */
