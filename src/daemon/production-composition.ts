...
const ADAPTER_FEATURES: Readonly<Record<ProductionAdapterKind, readonly ControlPlaneFeature[]>> = {
	...
	model_provider: ["turn", "plan_context_memory"],
	session_reader: ["session", "queue", "event_subscription", "plan_context_memory"],
	session_writer: ["session", "turn", "queue", "shutdown", "plan_context_memory"],
	workspace: ["session", "turn", "shutdown", "plan_context_memory"],
	capability_gateway: ["session", "turn", "approval", "change_proposal", "artifact", "shutdown", "plan_context_memory"],
	approval: ["approval", "turn", "shutdown", "plan_context_memory"],
	sandbox: ["session", "turn", "shutdown"],
	artifact: ["session", "turn", "change_proposal", "artifact", "shutdown", "plan_context_memory"],
	artifact_key_provider: ["turn", "change_proposal", "artifact", "shutdown", "plan_context_memory"],
	resource_catalog: ["turn", "plan_context_memory"],
	resource_invoker: ["turn", "shutdown", "plan_context_memory"],
