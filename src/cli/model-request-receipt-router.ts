/** Final-leaf model route gate with a canonical bounded receipt. */
...
import type { RuntimeEventAppendInput, RuntimeEventWriter } from "../storage/runtime-event-store.ts";
...
import type { AuthorityId, PrincipalId, SessionId, TenantId, TurnId } from "../runtime/contracts/public.ts";

export interface ModelRequestReceiptRouterOptions {
...
export function createModelRequestReceiptRouter(options: ModelRequestReceiptRouterOptions): ModelRequestRouter {
...
function modelRoutedEvent(options: ModelRequestReceiptRouterOptions, request: ModelRouteRequest, decision: ModelRouteDecision): RuntimeEventAppendInput {
