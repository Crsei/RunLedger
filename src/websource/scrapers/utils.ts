import { isRecord, combineSignals } from "../internal/platform.ts";

export { isRecord };

import { ToolAbortError } from "../internal/abort.ts";
import { MAX_BYTES, type ScraperContext } from "./types.ts";
 ...
 */
export async function fetchBinary(context: ScraperContext, url: string, timeout: number = 20, signal?: AbortSignal): Promise<BinaryFetchResult> {
