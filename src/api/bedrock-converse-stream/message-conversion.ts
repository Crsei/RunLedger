/**
 * S8.4 拆分:message 转换与 image/text block 构造。
 */
...
import type { CacheRetention, Context, ImageContent, Model, ProviderEnv, TextContent, ToolResultMessage } from "../../types.ts";
import { sanitizeSurrogates } from "../../utils/sanitize-unicode.ts";
import { transformMessages } from "../transform-messages.ts";
import { createImageBlock, supportsPromptCaching, supportsThinkingSignature } from "./request-fields.ts";
